...
function rhs = op_f_sv_st_tp(spaceS,spaceT,mshS,mshT,coeff)
...
%  end
  ...
  for iel = 1:mshS.nel_dir(1)
    ...
    sp_col  = sp_evaluate_col (spaceS, msh_col, 'value', true, 'laplacian', true);
    ...
    rhs = rhs + op_f_sv_st(sp_col,sp_colT,msh_col,msh_colT,coeff(x{:}));
  end
